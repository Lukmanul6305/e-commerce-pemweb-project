    ...
    <div className="homepage">
          ...
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              <h1 className="mb-4 animate__animated animate__bounceInUp animeate__delay-1s">
                Belajar Skill Digital <br /> yang Dibutuhkan Dunia Kerja Sekarang
              </h1>
              <p className="mb-4 animate__animated animate__fadeInUp animeate__delay-1s">
                Mulai dari dasar hingga mahir. Pelajari desain, coding, pemasaran digital, dan lebih banyak lagi—semua dalam satu platform, kapan saja, di mana saja
              </p>
              <button className="btn btn-dark btn-lg rounded-1 me-2 mb-xs-0 mb-2 animate__animated animate__fadeInUp animeate__delay-1s" onClick={() => Navigate("/kelas")}>
                Lihat Kelas
              </button>
              <button className="btn btn-outline-dark btn-lg rounded-1 mb-xs-0 mb-2 animate__animated animate__fadeInUp animeate__delay-1s">Lihat Promo</button>
            </Col>
            <Col lg="6" className="pt-lg-0 pt-5">
              <img src={HeroImage} alt="hero-img" className="animate__animated animate__backInUp" />
            </Col>
          </Row>
        </Container>
      </header>
        ...
        <Container>
          <Row>
            <Col>
              ...
              <p className="text-center mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, deleniti.</p>
            </Col>
          </Row>
          <Row>
              ...
              return (
                <Col key={kelas.id} className="shadow rounded" data-aos="fade-up" data-aos-duration="1000" data-aos-delay={kelas.delay}>
                  ...
                  <div className="ket d-flex justify-content-between align-items-center px-3 pb-3">
                    ...
                    <button className="btn btn-danger rounded-1" onClick={() => Navigate("/PembelajaranPage")}>
                      {kelas.buy}
                    </button>
                  </div>
                </Col>
      ...
      <div className="mentor-page">
        <Container>
          <Row>
            <Col>
              <h1 className="text-center p-5 fw-bold animate__animated animate__fadeInUp animate__delay-1s">Mentor</h1>
            </Col>
          </Row>
          <Row className="justify-content-center">
            <Col md={25} className="position-relative">
              <Swiper rewind={true} navigation={true} modules={[Navigation]} className="mySwiper" slidesPerView={1} centeredSlides={true} spaceBetween={0}>
                {mentor.map((data) => (
